...
export type ShapeKind = 'triangle' | 'trapezoid' | 'pentagon' | 'hexagon' | 'heptagon' | 'octagon' | 'star' | 'rect' | 'roundrect' | 'ellipse' | 'diamond' | 'parallelogram' | 'line' | 'arrow' | 'angle' | 'axes' | 'parabola'
